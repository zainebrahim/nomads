...
def get_train_set(data, r, channel_list, balance=False, positive_to_negative_ratio=1):
    ...
    valid_z_cent = list(range(volume.shape[0]))
    valid_y_cent = list(range(r + 1, volume.shape[1] - r - 1))
    valid_x_cent = list(range(r + 1, volume.shape[2] - r - 1))
